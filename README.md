...
I made these because build the old version on Linux was impossible due the actualizations on the process and new bugs, for now I will try to learn how to code C++ to help the complete implementation of Spectral on Krita.
